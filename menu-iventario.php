...
<body>
<div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="imagens/logoclear.jpg" width="433" height="45" alt="Clear Channel" class="imagem-com-sombra">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>[  Inventário ]</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://showeb.com.br/clear/excel/" target="_blank">Importar <img src="imagens/excel.png"> *.cvs</a>    <span style="float: right;"><a href="/clear/menuprincipal.php"><img src="imagens/exit.jpg" width="64" height="60" alt=""></a>&nbsp;&nbsp;<a href="#" id="mostrarDivLink"><img src="imagens/ajuda.png" width="30" height="30" alt="Ajuda"></a></span>

<table width="1100"  border="1" class="tdtopotab">
  <!-- <tr>
    <td width="100" align="center"><a href="menu.php?pag=users"><h4>Admin Users</h4></a><?php // print $_SESSION['tipouser']; ?></td>
    <td width="100" align="center"><a href="menu.php?pag=estoque"><h4>Lista de estoque</h4></a></td>
     <td width="100" align="center"><a href="menu.php?pag=lista-empresas"><h4>Lista de Empresas</h4></a></td>
	<td width="100" align="center"><a href="menu.php?pag=entrada-saida"><h4>Entradas e Saidas</h4></a></td>
		 <td width="100" align="center"><a href="menu.php?pag=iventario"><h4>Inventário</h4></a></td>
	<td width="100" align="center"><a href="/clear/menuprincipal.php"><h4></h4><img src="imagens/exit.jpg" width="64" height="60" alt=""></a>

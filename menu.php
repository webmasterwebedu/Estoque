...
<div align="center"><img src="imagens/logoclear.jpg" width="453" height="55" alt="Clear Channel" class="imagem-com-sombra"><br />&nbsp;&nbsp;<strong>[ Adm Estoque ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php print "User: ".$_SESSION['username']; ?></strong>&nbsp;<span style="float: right;"><a href="menuprincipal.php"><img src="imagens/exit.jpg" width="64" height="60" alt=""></a>&nbsp;&nbsp;<a href="#" id="mostrarDivLink"><img src="imagens/ajuda.png" width="30" height="30" alt="Ajuda"></a></span>
 <br>
<table width="1100"  border="1" class="tdtopotab">
  <tr>
    <!--<td width="100" align="center"><a href="menu.php?pag=users"><h4>Admin Users</h4></a></td>-->
